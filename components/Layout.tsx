    ...
    <div className="flex flex-col min-h-screen font-sans text-primary bg-secondary">
        ...
        <div className="container mx-auto px-4 md:px-6 flex justify-between items-center">
          ...
          >
            {isMenuOpen ? (
              ...
              <Menu size={28} color={scrolled ? '#0f172a' : '#ffffff'} />
            )}
          </button>
        </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12 border-b border-gray-700 pb-12">
            ...
            <div className="space-y-4">
              ...
              <p className="text-gray-400 leading-relaxed max-w-xs">
                Une cuisine authentique au cœur de Saly. Fruits de mer frais, grillades et saveurs
                locales dans un cadre élégant.
              </p>
              <div className="flex space-x-4 pt-4">
                ...
                <a
                  href={SITE_INFO.socials.tripadvisor}
                  className="p-2 bg-gray-800 rounded-full hover:bg-accent transition-colors"
                >
                  <Star size={20} />
                </a>
      ...
      <div className="md:hidden fixed bottom-6 right-6 z-50">
        <a
          ...
          className="flex items-center justify-center w-14 h-14 bg-accent text-white rounded-full shadow-2xl hover:bg-amber-700 transition-colors"
        >
          <Phone size={24} />
        </a>
      </div>
